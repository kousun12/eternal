export default {
  ...
  globalFontFamily: 'monaco, Monaco, Consolas, "Source Code Pro", "Lucida Console", monospace, sans-serif',
  ...
  editInputFontFamily: 'monaco, Monaco, Consolas, "Source Code Pro", "Lucida Console", monospace, sans-serif',
